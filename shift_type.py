...
class ShiftType(Document):
	...
	def get_attendance(self, logs):
		...
		if (late_mins > 90):
			return "Half Day", total_working_hours, late_entry, early_exit, in_time, out_time, 0
		if (
		...
		if (
			...
			return "Absent", total_working_hours, late_entry, early_exit, in_time, out_time, 0
		...
		return "Present", total_working_hours, late_entry, early_exit, in_time, out_time, late_mins
